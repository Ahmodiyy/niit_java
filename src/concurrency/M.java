...
class PriorityDemo {
    public static void main(String args[]) {
        ChildThread obj1 = new ChildThread(Thread.MAX_PRIORITY - 2);// 8
        ChildThread obj2 = new ChildThread(Thread.NORM_PRIORITY - 2);// 3
        ChildThread obj3 = new ChildThread(Thread.NORM_PRIORITY - 3);//2
